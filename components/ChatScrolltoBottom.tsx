...
const ChatScrolltoTop = ({
	...
	return (
		<div
			...
			} sticky top-[80%] translate-y-1/2 mx-auto  text-white active:scale-[1.03] h-14 w-14 grid aspect-square justify-center items-center rounded-full cursor-pointer`}
		>
