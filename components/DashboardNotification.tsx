...
const DashboardNotification = ({
	...
	return (
		<div className="bg-[#071f07] border-grey-light rey-light no-select border z-40 border-white/10 w-[300px] sm:w-[350px] absolute top-12 p-3 rounded-xl right-full md:right-1/2 md:translate-x-1/3 translate-x-[27%] sm:translate-x-0 sm:-right-2">
