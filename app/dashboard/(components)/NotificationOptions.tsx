...
const NotificationOptions = ({
	...
	return (
		<div className="bg-[#071f07] border-grey-light rey-light select-none border z-40 border-white/10 w-[300px] sm:w-[350px] absolute top-12 p-3 rounded-xl right-[-100px] md:right-0">
			...
			<div className="h-[150px] overflow-y-auto overscroll-none [scrollbar-width:thin]">
				<NotificationLogic
