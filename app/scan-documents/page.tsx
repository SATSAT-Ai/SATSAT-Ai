	...
	const featuresData: featureData[] = [
		{
			...
			title: "PDF",
			para: " amet amet pellentesque. Arcu mollis sem aenean aliquam diam enim tortor et. placerat in pellentesque. Eget ut adipiscing in ac. Turpis nunc sit in erat .",
			id: "pdf",
		},
		{
		...
		<>
			...
			<div className="bg-darker">
				...
				<main className="z-10 relative grid items-center justify-center my-max">
					...
					<GlowCardParent className="flex flex-col md:flex-row gap-5">
