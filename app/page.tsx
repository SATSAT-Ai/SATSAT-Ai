...
export default function Home() {
	return (
		<div className="bg-darker min-h-screen overflow-hidden relative">
			<section className=" h-screen text-center flex flex-col relative z-0 ">
				<div className="green-blob w-96 h-96 top-[-50%] md:top-[-25%] left-[50%]"></div>
				<div className="my-max flex flex-col items-center justify-center h-[80%] w-full">
					<h1 className="text-brand-green max-w-5xl mx-auto text-text-40 md:text-text-60">
						SATSAT Ai
					</h1>
			...
			<main className="md:py-36">
					...
					<section className="text-center flex flex-col">
						...
						<div className=" relative mt-10 md:mt-20 grid gap-5 mx-auto grid-cols-1 sm:grid-cols-2 max-w-4xl">
							...
							<div className="text-white z-0 p-5 rounded-3xl  sm:bg-brand-green-darker flex flex-col items-center justify-center">
								<button
									type="button"
									className="flex items-center gap-3 md:border md:border-white active:scale-[1.01] button  hover:bg-mid--yellow md:hover:bg-darker rounded-2xl transition-all bg-brand-green-darker"
								>
									Get started
							...
							<div className=" grid gap-5 grid-cols-1 sm:grid-cols-2">
								...
								<div className="text-white p-10 rounded-3xl bg-white/10 flex flex-col items-start text-left justify-center">
									...
									<p className="text-grey-lightest">
										...
										seconds without wading through endless documents on their
										drives. SATSAT Ai scans, understands, and presents relevant
										information ensuring you spend less time searching and more
										time acting
									</p>
								</div>
								<div className="text-white p-10 rounded-3xl bg-white/10 flex flex-col items-start text-left justify-center">
									<Image src={chatBot} height={50} width={50} alt="chatbot" />
									<h3 className="text-text-20 ">Collaborative Intelligence</h3>
									<p className="text-grey-lightest">
								...
								<div className="text-white p-10 rounded-3xl bg-white/10 flex flex-col items-start text-left justify-center">
									...
									<p className="text-grey-lightest">
										...
										ensures maximum protection behind your firewall, so you can
								...
								<div className="text-white z-0 p-5 rounded-3xl sm:bg-brand-green-darker flex flex-col items-center justify-center">
									<button
										type="button"
										className="flex items-center gap-2 md:border-[1px] active:scale-[1.01] md:border-white button hover:bg-mid--yellow md:hover:bg-darker rounded-2xl transition-all bg-brand-green-darker"
									>
										Get started
										<MdArrowForward color="white" size="25" />
									</button>
						...
						<div className="mt-20 md:max-w-5xl mx-auto grid gap-10 grid-cols-1 lg:grid-cols-2">
							<div className="text-left relative">
								...
								<p className="text-mid--yellow mb-5 max-w-md">
									Enjoy fast, secure and reliable way of Querying financial data
									with SATSAT Ai
								</p>
								<button
									type="button"
				...
				<section className="text-center flex flex-col w-full overflow-x-auto ">
					...
					<p className="text-mid--yellow max-w-xl mx-auto text-text-normal md:text-text-normal">
						SATSAT Ai can scan documents like invoices, mobile money statements,
						bank statements and receipts. These are some of the banks and mobile
