import { BsFillFileEarmarkBreakFill, BsRobot } from "react-icons/bs";
...
export const featuresData: featureData[] = [
	{
		icon: <BsFillFileEarmarkBreakFill size={40} color="#c18e3b" />,
	...
	{
		icon: <MdDashboard size={40} color="#c18e3b" />,
		title: "Intuitive Dashboard",
		para: " amet amet pellentesque. Arcu mollis sem aenean aliquam diam enim tortor et. Pharetra neque interdum ac arcu nec morbi placerat in pellentesque. Eget ut adipiscing in ac. Turpis nunc sit in erat tristique facilisi vitae nec morbi.",
		link: "#",
	},
	{
		icon: <PiDetectiveFill size={40} color="#c18e3b" />,
		title: "Fraud Detection",
		para: " amet amet pellentesque. Arcu mollis sem aenean aliquam diam enim tortor et. Pharetra neque interdum ac arcu nec morbi placerat in pellentesque. Eget ut adipiscing in ac. Turpis nunc sit in erat tristique facilisi vitae nec morbi.",
		link: "#",
	},
	{
		icon: <BsRobot size={40} color="#c18e3b" />,
		title: "AI chatbot",
		para: " amet amet pellentesque. Arcu mollis sem aenean aliquam diam enim tortor et. Pharetra neque interdum ac arcu nec morbi placerat in pellentesque. Eget ut adipiscing in ac. Turpis nunc sit in erat tristique facilisi vitae nec morbi.",
		link: "#",
	},
	...
	{
		icon: <GiArtificialIntelligence size={40} color="#c18e3b" />,
		title: "Artificial Intelligence and Machine Learning",
		para: " amet amet pellentesque. Arcu mollis sem aenean aliquam diam enim tortor et. Pharetra neque interdum ac arcu nec morbi placerat in pellentesque. Eget ut adipiscing in ac. Turpis nunc sit in erat tristique facilisi vitae nec morbi.",
		link: "#",
	},
	{
		icon: <HiDocumentSearch size={40} color="#c18e3b" />,
		title: "Insight to financial documents",
		para: " amet amet pellentesque. Arcu mollis sem aenean aliquam diam enim tortor et. Pharetra neque interdum ac arcu nec morbi placerat in pellentesque. Eget ut adipiscing in ac. Turpis nunc sit in erat tristique facilisi vitae nec morbi.",
		link: "#",
	},
	{
